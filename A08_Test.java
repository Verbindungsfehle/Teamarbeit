...
public class A08_Test {
	...
	public static void main(String[] args) {
		...
		Flaeche f = new Flaeche(3, 4, 5); //erzeugen einer neuen Fläche
		System.out.printf("Testen der Flächen-Methoden\n"); //"Header"
		System.out.printf("Die Fläche ist: %f\n", f.getFlaeche()); //ausgeben des Flächeninhalts
		...
		/* Hinzufügen von allen möglichen Test-Werten */
		z.add(3.5);
		z.add(4.8);
		z.add(2.3);
		System.out.printf("Die Summe beträgt: %f\n", z.getSumme()); //ausgeben der Summe
